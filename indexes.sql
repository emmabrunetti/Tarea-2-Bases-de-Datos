...
-- Indices creados origialmente para atacar Q10 pero empeoró el tiempo total:

-- Índice 3: reviews por review_date, book_id, user_id
--CREATE INDEX idx_reviews_date_user_book ON reviews(review_date, book_id, user_id);
-- Índice 4: order_items por book_id
